\subsection{Implementation V1} \label{sec:Implementation1}
    ...
    \begin{itemize}
        ...
        % \item MySqlConnectionController \\ %! V2
        %     Dieser Controller hat die Aufgabe die Erreichbarkeit der Datenbank zu überprüfen. %! V2
    ...
    % Konvertierung von und in \ac{JSON} zu Controller (oben die Punkte)
    % \begin{itemize}
